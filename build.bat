...
if exist "C:\Program Files\7-Zip\7z.exe" (
  "C:\Program Files\7-Zip\7z.exe" a -tzip "Systemless-Hosts v%version%.zip" * -x!.git -x!.gitattributes -x!build.bat -x!README.md
) else if exist "C:\Program Files (x86)\7-Zip\7z.exe" (
  "C:\Tools\7z.exe" a -tzip "Systemlless-Hosts v%version%.zip" * -x!.git -x!.gitattributes -x!build.bat -x!README.md
) else (
